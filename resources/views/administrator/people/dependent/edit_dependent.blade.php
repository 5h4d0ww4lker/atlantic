...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Dependent</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Dependent</h3>
            ...
            <!-- /.box-header -->
            <form action="{{ url('people/dependents/update/'.$dependent->id) }}" method="post" name="employee_add_form" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <!-- Notification Box -->
...
?>
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('dependent_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="dependent_name" id="dependent_name" class="form-control" value="{{$dependent->dependent_name}}" placeholder="Enter name..">
                                @if ($errors->has('name'))
                                <span class="help-block">
       ...
       <label for="relationship">Relationship <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('relationship') ? ' has-error' : '' }} has-feedback">
                                <select name="relationship" id="relationship" class="form-control">
                                    <option value="{{$dependent->relationship}}" selected>{{$dependent->relationship}}</option>
                            ...
                            <div class="form-group{{ $errors->has('profile_picture') ? ' has-error' : '' }} has-feedback">
                             ...
                             @if(!empty($dependent->profile_picture))
                            <img src="{{ url('/public/profile_picture/' . $dependent->profile_picture) }}" alt="Image" class="img-responsive img-thumbnail" width="200px" height="100px">
                            @else
