...
$employee1 = \App\User::find($reference->employee_id);
?>
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="reference_name" id="reference_name" class="form-control" value="{{ $reference->reference_name }}" placeholder="Enter name..">
                                @if ($errors->has('name'))
                                <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('contact_no_one') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="contact_no" id="contact_no" class="form-control" value="{{ $reference->contact_no}}" placeholder="Enter contact no..">
                            ...
                            <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }} has-feedback">
                                <select name="gender" id="gender" class="form-control">
                                    <option value="{{$reference->gender}}" selected>{{$reference->gender}}</option>
                            ...
                            <div class="form-group{{ $errors->has('present_address') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="address" id="address" class="form-control" value="{{ $reference->address }}" placeholder="Enter address..">
