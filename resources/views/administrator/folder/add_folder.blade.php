                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('folder_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="folder_name" id="folder_name" class="form-control" value="{{ old('folder_name') }}" placeholder="Enter folder name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('folder_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="folder_description" id="folder_description" placeholder="Enter folder description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('folder_description') }}</textarea>
                                @if ($errors->has('folder_name'))
                                <span class="help-block">
