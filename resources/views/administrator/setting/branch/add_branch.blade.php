...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <!-- /.box-header -->
            <form action="{{ url('setting/branchs/store') }}" method="post" name="branch_add_form">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <!-- Notification Box -->
                        <div class="col-md-12">
                            ...
                            @else
                                <p class="text-yellow">Enter branch details. All field are required. </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('branch') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="branch" id="branch" class="form-control" value="{{ old('branch') }}" placeholder="Enter branch name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('branch_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="branch_description" id="branch_description" placeholder="Enter branch description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('branch_description') }}</textarea>
                                @if ($errors->has('branch'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Add branch</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['branch_add_form'].elements['publication_status'].value = "{{ old('publication_status') }}";
</script>
@endsection
