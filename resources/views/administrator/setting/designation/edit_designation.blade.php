                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('designation') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="designation" id="designation" class="form-control" value="{{ $designation['designation'] }}" placeholder="Enter Designation Name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('designation_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="designation_description" id="designation_description" placeholder="Enter Designation Description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $designation['designation_description'] }}</textarea>
                                @if ($errors->has('designation'))
                                <span class="help-block">
