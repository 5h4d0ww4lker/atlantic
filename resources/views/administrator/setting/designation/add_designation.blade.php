        ...
        <div class="box box-default">
            ...
            <form action="{{ url('setting/designations/store') }}" method="post" name="designation_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                                <p class="text-yellow">Enter designation details. All field are required. </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Add designation</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
