...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add bonus category</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Add bonus category</h3>
            ...
            <!-- /.box-header -->
            <form action="{{ url('setting/bonus_categories/store') }}" method="post" name="bonus_category_add_form">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <!-- Notification Box -->
                        <div class="col-md-12">
                            ...
                            @else
                                <p class="text-yellow">Enter bonus_category details. All field are required. </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('bonus_category') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="bonus_category" id="bonus_category" class="form-control" value="{{ old('bonus_category') }}" placeholder="Enter Bonus name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('bonus_category_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="bonus_category_description" id="bonus_category_description" placeholder="Enter Bonus description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('bonus_category_description') }}</textarea>
                                @if ($errors->has('bonus_category'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Add bonus category</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['bonus_category_add_form'].elements['publication_status'].value = "{{ old('publication_status') }}";
</script>
@endsection
