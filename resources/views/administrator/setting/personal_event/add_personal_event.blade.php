...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add personal event</li>
        </ol>
    </section>
        ...
        <div class="box box-default">
            ...
            <form action="{{ url('setting/personal-events/store') }}" method="post" name="personal_event_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                                <p class="text-yellow">Enter personal_event details. All field are required. </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Add personal event</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
