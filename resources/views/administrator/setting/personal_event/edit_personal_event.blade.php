                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('personal_event') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="personal_event" id="personal_event" class="form-control" value="{{ $personal_event['personal_event'] }}" placeholder="Enter Event name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('personal_event_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="personal_event_description" id="personal_event_description" placeholder="Enter Event description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $personal_event['personal_event_description'] }}</textarea>
                                @if ($errors->has('personal_event'))
                                <span class="help-block">
