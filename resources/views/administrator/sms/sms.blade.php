    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <form action="{{ url('/sendMail') }}" method="post" name="file_name_add_form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div id="individual">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="caption">Email Address <span class="text-danger">*</span></label>
                                <div class="form-group{{ $errors->has('caption') ? ' has-error' : '' }} has-feedback">
                                    <input type="text" name="caption" id="caption" class="form-control" value="{{ old('caption') }}" placeholder="Enter Email Address..">
                         ...
                         <div class="row">
                            <div class="col-md-6">
                                <label for="caption">Subject <span class="text-danger">*</span></label>
...
?>
                ...
                <form action="{{ url('/bulkMail/') }}" method="post" name="file_name_add_form" enctype="multipart/form-data">
                    {{ csrf_field() }}
