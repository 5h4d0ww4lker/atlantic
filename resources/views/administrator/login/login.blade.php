...
<style type="text/css">
body,html { 
  background: url('/public/images6.jpg') no-repeat center center fixed; 
...
<body>
    <div class="login-box">
        ...
        <div class="login-box-body">
             <img src="{{ asset('public/index.png') }}" class="img-circle" alt="User Image" style="margin-left: 25%;">
        <div class="login-logo">

            <a><b>Atlantic HRMS</b></a>
