<header class="main-header">
    ...
    <a href="{{ url('/dashboard') }}" class="logo">
        ...
        <span class="logo-mini"><b>Atlantic HRMS</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Atlantic HRMS</b></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ asset('public/profile_picture/'.auth()->user()->profile_picture) }}" class="user-image" alt="User Image">
                        @else
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            @if(!empty(auth()->user()->profile_picture))
                            <img src="{{ asset('public/profile_picture/'.auth()->user()->profile_picture) }}" class="img-circle" alt="User Image">
                            @else
