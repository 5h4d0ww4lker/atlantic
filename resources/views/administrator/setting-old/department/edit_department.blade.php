                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="department" id="department" class="form-control" value="{{ $department['department'] }}" placeholder="Enter department name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('department_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="department_description" id="department_description" placeholder="Enter department description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $department['department_description'] }}</textarea>
                                @if ($errors->has('department'))
                                <span class="help-block">
