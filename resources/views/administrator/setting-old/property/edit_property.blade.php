...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/setting/properties/update/'. $property['id']) }}" method="post" name="property_edit_form">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        <!-- Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- /.form-group -->
                            <label for="publication_status">Property Identification <span class="text-danger">*</span></label>
                              <div class="form-group{{ $errors->has('property_identification') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="property_identification" id="property" class="form-control" value="{{ $property['property_identification'] }}" placeholder="Enter property name..">
