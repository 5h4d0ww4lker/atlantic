            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="basic_salary" class="form-control" id="basic_salary" value="{{ old('basic_salary') }}" placeholder="Enter basic salary..">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="form-group{{ $errors->has('house_rent_allowance') ? ' has-error' : '' }}">
                ...
                <input type="number" name="house_rent_allowance" value="{{ old('house_rent_allowance') }}" class="form-control" id="house_rent_allowance" placeholder="Enter house rent allowance..">
              ...
              <div class="form-group{{ $errors->has('medical_allowance') ? ' has-error' : '' }}">
                ...
                <input type="number" name="medical_allowance" value="{{ old('medical_allowance') }}" class="form-control" id="medical_allowance" placeholder="Enter medical allowance..">
              ...
              <div class="form-group{{ $errors->has('special_allowance') ? ' has-error' : '' }}">
                ...
                <input type="number" name="special_allowance" value="{{ old('special_allowance') }}" class="form-control" id="special_allowance" placeholder="Enter special allowance..">
              ...
              <div class="form-group{{ $errors->has('provident_fund_contribution') ? ' has-error' : '' }}">
                ...
                <input type="number" name="provident_fund_contribution" value="{{ old('provident_fund_contribution') }}" class="form-control" id="provident_fund_contribution" placeholder="Enter provident fund contribution..">
              ...
              <div class="form-group{{ $errors->has('other_allowance') ? ' has-error' : '' }}">
                ...
                <input type="number" name="other_allowance" value="{{ old('other_allowance') }}" class="form-control" id="other_allowance" placeholder="Enter other allowance..">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div class="form-group{{ $errors->has('other_deduction') ? ' has-error' : '' }}">
                ...
                <input type="number" name="other_deduction" value="{{ old('other_deduction') }}" class="form-control" id="other_deduction" placeholder="Enter other deduction..">
        ...
        <div class="col-md-offset-6 col-md-6">
          <div class="box box-danger">
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-primary btn-flat pull-right"><i class="fa fa-save"></i> Save Details</button>
            </div>
          </div>
        </div>
        <!-- /.end.col -->
