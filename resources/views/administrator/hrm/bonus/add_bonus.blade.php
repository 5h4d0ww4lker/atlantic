        ...
        <div class="box box-default">
            ...
            <form action="{{ url('/hrm/bonuses/store') }}" method="post" name="bonus_add_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('bonus_amount') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="bonus_amount" id="bonus_amount" class="form-control" value="{{ old('bonus_amount') }}" placeholder="Enter bonus name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('bonus_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="bonus_description" id="bonus_description" placeholder="Enter client description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('bonus_description') }}</textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Add bouns</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
