        ...
        <div class="box">
            ...
            <div class="box-body">
                <a href="{{ url('/hrm/employee-awards/create') }}" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add employee award</a>
                 <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="{{ url('/hrm/employee-awards/print/') }}"><i class="icon fa fa-print"></i> Print</a></li>
                                        <li><a href="{{ url('/hrm/employee-awards/pdf/') }}"><i class="icon fa fa-file"></i> PDF</a></li>
                                        <li><a href="{{ url('/hrm/employee-awards/excel/') }}"><i class="icon fa fa-list"></i> Excel</a></li>
                                    </ul>
                                </div>
                <hr>
                <!-- Notification Box -->
                ...
                <!-- /.Notification Box -->
                     ...
                     <form action="{{ url('hrm/employee-awards') }}" method="get" name="employee_add_form" enctype="multipart/form-data">
    <p id="date_filter">
         {{ csrf_field() }}
