...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/hrm/loans') }}">Manage Loan</a></li>
        ...
        <div class="box box-default">
            ...
            <form action="{{ url('/hrm/loans/store') }}" method="post" name="loan_add_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('loan_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="loan_name" id="loan_name" class="form-control" value="{{ old('loan_name') }}" placeholder="Enter loan name..">
                            ...
                            <label for="number_of_installments">Number of Installment <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('number_of_installments') ? ' has-error' : '' }} has-feedback">
                                    <input type="text" name="number_of_installments" class="form-control pull-right" value="{{ old('number_of_installments') }}" id="number_of_installments" placeholder="Enter number of installment">
                            ...
                            <div class="form-group{{ $errors->has('loan_amount') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="loan_amount" id="loan_amount" class="form-control" value="{{ old('loan_amount') }}" placeholder="Enter loan name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('loan_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="loan_description" id="loan_description" placeholder="Enter client description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('loan_description') }}</textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Add loan</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
