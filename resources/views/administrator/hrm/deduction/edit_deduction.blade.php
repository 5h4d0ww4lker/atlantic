        ...
        <div class="box box-default">
            ...
            <form action="{{ url('/hrm/deductions/update/' . $deduction['id']) }}" method="post" name="deduction_add_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('deduction_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="deduction_name" id="deduction_name" class="form-control" value="{{ $deduction['deduction_name'] }}" placeholder="Enter deduction name..">
                            ...
                            <div class="form-group{{ $errors->has('deduction_amount') ? ' has-error' : '' }} has-feedback">
                                <input type="number" name="deduction_amount" id="deduction_amount" class="form-control" value="{{ $deduction['deduction_amount'] }}" placeholder="Enter deduction name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('deduction_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="deduction_description" id="deduction_description" placeholder="Enter client description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $deduction['deduction_description'] }}</textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> Update deduction</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
